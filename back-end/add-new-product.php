                    ...
                    <div class="card-body">
                      ...
                      <form @submit="addProduct" class="theme-form theme-form-2 mega-form">
                        ...
                        <div class="mb-4 row align-items-center">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="number" required name="price" step="0.01" required placeholder="₱99.99" />
                          </div>
                        </div>
                        ...
                        <div class="mb-4 row align-items-center">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control form-choose" name="products[]" required type="file" id="formFile" multiple />
                          </div>
                        </div>
                        <div class="mb-4 row align-items-center">
